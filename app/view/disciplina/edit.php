<?php
  ...
  $disciplina = $disciplinaDAO->findById($_GET['id']);
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
          ...
          <div class="col-md-6">
            <div class="card">
              <div class="header">
                ...
                <div class="content">
                  <form action="../../controller/disciplinaController/editar.php" method="POST">
                   <div class="row">
                       <div class="col-md-12">
                           <div class="form-group">
                               <label>Nome</label>
                               <input type="hidden" id="id" name="id" value="<?php echo $_GET['id']; ?>">
                               <input type="text" class="form-control" id="nome" name="nome" placeholder="Digite o nome..." value="<?php echo $disciplina->getNome(); ?>" />
                           </div>
                       </div>
                   </div>
